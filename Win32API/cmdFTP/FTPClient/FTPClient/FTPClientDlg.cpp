...
{
	// TODO: 在此添加控件通知处理程序代码
	//ShellExecute(NULL,_T("open"),_T("ftp.exe"),_T("-s:upload"),NULL,SW_HIDE);
	system("ftp -s:upload");
	MessageBox(_T("上传成功!"),_T("提示"), 0);
}
...
{
	// TODO: 在此添加控件通知处理程序代码
	//ShellExecute(NULL,_T("open"),_T("ftp.exe"),_T("-s:download"),NULL,SW_HIDE);
	system("ftp -s:download");
	MessageBox(_T("下载成功!"),_T("提示"), 0);
}
